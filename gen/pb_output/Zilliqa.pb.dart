...
class Transaction_Raw extends $pb.GeneratedMessage {
  ...
  factory Transaction_Raw.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Transaction_Raw.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  @$pb.TagNumber(2)
  set code($core.List<$core.int> value) => $_setBytes(1, value);
  @$pb.TagNumber(2)
...
class Transaction extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set rawTransaction(Transaction_Raw value) => $_setField(2, value);
  @$pb.TagNumber(2)
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(7)
  set transaction(Transaction value) => $_setField(7, value);
  @$pb.TagNumber(7)
