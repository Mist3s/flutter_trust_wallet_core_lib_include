...
class TransferMessage extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set feeAsset($core.String value) => $_setString(3, value);
  @$pb.TagNumber(4)
  $core.bool hasFeeAsset() => $_has(3);
  @$pb.TagNumber(4)
  void clearFeeAsset() => $_clearField(4);
  ...
  @$pb.TagNumber(6)
  set attachment($core.List<$core.int> value) => $_setBytes(5, value);
  @$pb.TagNumber(6)
  $core.bool hasAttachment() => $_has(5);
  @$pb.TagNumber(6)
  void clearAttachment() => $_clearField(6);
}
...
class LeaseMessage extends $pb.GeneratedMessage {
  ...
  factory LeaseMessage.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory LeaseMessage.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class CancelLeaseMessage extends $pb.GeneratedMessage {
  ...
  CancelLeaseMessage._();

  factory CancelLeaseMessage.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory CancelLeaseMessage.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class SigningInput extends $pb.GeneratedMessage {
  factory SigningInput({
    ...
    if (leaseMessage != null) result.leaseMessage = leaseMessage;
    if (cancelLeaseMessage != null) result.cancelLeaseMessage = cancelLeaseMessage;
    return result;
  }
  ...
  @$pb.TagNumber(3)
  set transferMessage(TransferMessage value) => $_setField(3, value);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set leaseMessage(LeaseMessage value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasLeaseMessage() => $_has(3);
  @$pb.TagNumber(4)
  void clearLeaseMessage() => $_clearField(4);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set cancelLeaseMessage(CancelLeaseMessage value) => $_setField(5, value);
  @$pb.TagNumber(5)
  $core.bool hasCancelLeaseMessage() => $_has(4);
  @$pb.TagNumber(5)
  void clearCancelLeaseMessage() => $_clearField(5);
  @$pb.TagNumber(5)
