...
class SwapInput extends $pb.GeneratedMessage {
  factory SwapInput({
    ...
    if (affiliateFeeAddress != null) result.affiliateFeeAddress = affiliateFeeAddress;
    if (affiliateFeeRateBp != null) result.affiliateFeeRateBp = affiliateFeeRateBp;
  ...
  factory SwapInput.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory SwapInput.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class SwapOutput extends $pb.GeneratedMessage {
  ...
  factory SwapOutput.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory SwapOutput.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SwapOutput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.THORChainSwap.Proto'), createEmptyInstance: create)
    ...
    ..aOM<$0.SigningInput>(4, _omitFieldNames ? '' : 'bitcoin', subBuilder: $0.SigningInput.create)
    ..aOM<$1.SigningInput>(5, _omitFieldNames ? '' : 'ethereum', subBuilder: $1.SigningInput.create)
    ..aOM<$2.SigningInput>(6, _omitFieldNames ? '' : 'binance', subBuilder: $2.SigningInput.create)
    ..aOM<$3.SigningInput>(7, _omitFieldNames ? '' : 'cosmos', subBuilder: $3.SigningInput.create)
    ..hasRequiredFields = false
  ;
