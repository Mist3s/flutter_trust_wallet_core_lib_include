...
class TransactionCoinFrom extends $pb.GeneratedMessage {
  ...
  factory TransactionCoinFrom.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory TransactionCoinFrom.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class TransactionCoinTo extends $pb.GeneratedMessage {
  ...
  factory TransactionCoinTo.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory TransactionCoinTo.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Transaction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Transaction', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.NULS.Proto'), createEmptyInstance: create)
    ...
    ..aOM<TransactionCoinFrom>(5, _omitFieldNames ? '' : 'input', subBuilder: TransactionCoinFrom.create)
    ..aOM<TransactionCoinTo>(6, _omitFieldNames ? '' : 'output', subBuilder: TransactionCoinTo.create)
  ...
  @$pb.TagNumber(5)
  set input(TransactionCoinFrom value) => $_setField(5, value);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set output(TransactionCoinTo value) => $_setField(6, value);
  @$pb.TagNumber(6)
