...
class SigningInput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  set toAddress($core.String value) => $_setString(5, value);
  @$pb.TagNumber(6)
  $core.bool hasToAddress() => $_has(5);
  @$pb.TagNumber(6)
  void clearToAddress() => $_clearField(6);
  ...
  @$pb.TagNumber(8)
  set timestamp($core.List<$core.int> value) => $_setBytes(7, value);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(10)
  set privateKey($core.List<$core.int> value) => $_setBytes(9, value);
  @$pb.TagNumber(10)
  $core.bool hasPrivateKey() => $_has(9);
  @$pb.TagNumber(10)
  void clearPrivateKey() => $_clearField(10);
}
...
class SigningOutput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set algorithm($core.int value) => $_setUnsignedInt32(0, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set raw($core.String value) => $_setString(2, value);
  @$pb.TagNumber(3)
...
class RawTransaction extends $pb.GeneratedMessage {
  ...
  factory RawTransaction.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory RawTransaction.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  @$pb.TagNumber(2)
  set from($core.List<$core.int> value) => $_setBytes(1, value);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set to($core.List<$core.int> value) => $_setBytes(2, value);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(7)
  set data(Data value) => $_setField(7, value);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set chainId($core.int value) => $_setUnsignedInt32(7, value);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  void clearGasPrice() => $_clearField(9);
  ...
  @$pb.TagNumber(10)
  void clearGasLimit() => $_clearField(10);

  /// algorithm
  @$pb.TagNumber(11)
  $core.int get alg => $_getIZ(10);
  @$pb.TagNumber(11)
  set alg($core.int value) => $_setUnsignedInt32(10, value);
  @$pb.TagNumber(11)
  $core.bool hasAlg() => $_has(10);
  @$pb.TagNumber(11)
  void clearAlg() => $_clearField(11);

  /// signature
  @$pb.TagNumber(12)
  $core.List<$core.int> get sign => $_getN(11);
  @$pb.TagNumber(12)
  set sign($core.List<$core.int> value) => $_setBytes(11, value);
  @$pb.TagNumber(12)
  $core.bool hasSign() => $_has(11);
  @$pb.TagNumber(12)
  void clearSign() => $_clearField(12);
}
