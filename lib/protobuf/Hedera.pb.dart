...
class TransactionID extends $pb.GeneratedMessage {
  factory TransactionID({
    ...
    final result = create();
    if (transactionValidStart != null) result.transactionValidStart = transactionValidStart;
  ...
  factory TransactionID.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory TransactionID.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class TransactionBody extends $pb.GeneratedMessage {
  factory TransactionBody({
    ...
    if (transactionValidDuration != null) result.transactionValidDuration = transactionValidDuration;
  ...
  factory TransactionBody.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory TransactionBody.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
