...
class ClaimPredicate extends $pb.ProtobufEnum {
  ...
  static final $core.List<ClaimPredicate?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 0);
  static ClaimPredicate? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
