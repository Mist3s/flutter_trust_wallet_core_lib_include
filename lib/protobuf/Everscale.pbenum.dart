...
class MessageBehavior extends $pb.ProtobufEnum {
  ...
  static final $core.List<MessageBehavior?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static MessageBehavior? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
